...
import { capiString } from "../utils/Constants";
...
console.log ("Data","routeName: " +  this.sideMenuData.routes[index] + " params:  " +this.arrayFinalSideMenu[index])
  ...
  openStore() {
    ...
    const PLAY_STORE_LINK = "market://details?id=com.desidhaba";
  ...
  shareApp() {
    ...
    const PLAY_STORE_LINK =
      "https://play.google.com/store/apps/details?id=com.desidhaba";

    const shareOptions = {
      title: "Share DesiDhaba Application",
